...
```
          ![Captura de tela da seção "Escolher uma licença" da nova página do repositório, incluindo um menu suspenso rotulado como "Licença."](/assets/images/help/repository/repository-license-picker.png)
```
