...
| passage-cleanup refine | deepseek-v4-flash, thinking high | passage-refine/v003, tool-v002 | 2026-08-13: v003 makes the existing unresolved-image protection explicit to the refiner. If a response still selects unresolved evidence, the passage terminates as auditable `unknown` instead of failing the source publication. Initial v002 rollout: local syllabus run r0003 applied two element-addressed revisions and retriaged both without rewriting source text. |
...
| task-triage | deepseek-v4-flash, thinking low | task-triage/v001 | 2026-08-13: Flash-low promoted after an exact 156-task comparison. `r0039` agreed with the Pro-high `r0032` on 155/156 verdicts (99.36%) and with Flash-high `r0040` on 156/156, while costing $0.2711 vs $2.6258 for Pro-high (89.68% less). The sole extra `supported` verdict was reviewed as a real false positive and accepted as the v1 cost/quality tradeoff. See `task-triage-flash-low-2026-08-13.md`. |
